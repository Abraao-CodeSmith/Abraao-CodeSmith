...
- 🎓 Graduado em **Gestão de Tecnologia da Informação** pela UNIESP (2025).
- 📍 Localizado em João Pessoa, Paraíba.
- 🎯 Atualmente focado em dominar o ecossistema **Node.js** e arquitetura de APIs.
- 🎨 Atuo profissionalmente com Design e Identidade Visual, trazendo um olhar apurado para a experiência do usuário e organização de projetos.
